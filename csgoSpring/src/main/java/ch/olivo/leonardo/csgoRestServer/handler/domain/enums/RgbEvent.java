...
public enum RgbEvent {
  ...
  LONGLINE(7, new ColorEvent(new Color(195, 77, 23), new Color(195, 60, 26),
      ColorEventType.FOURLEDSTRING)),
  MEDIUMLINE(7, new ColorEvent(new Color(195, 77, 23), new Color(195, 60, 26),
      ColorEventType.THREELEDSTRING)),
  SHORTLINE(7, new ColorEvent(new Color(195, 77, 23), new Color(195, 60, 26),
      ColorEventType.TWOLEDSTRING)),
  TASERSHOT(7, new ColorEvent(new Color(36, 80, 195), new Color(50, 115, 195),
      ColorEventType.FOURLEDSTRING)),
